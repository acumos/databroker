...
public class DataSourceController {
	...
	@RequestMapping(path = "/{datasourcekey}/status", method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	...
	@RequestMapping(path = "/{datasourcekey}/samples", method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody

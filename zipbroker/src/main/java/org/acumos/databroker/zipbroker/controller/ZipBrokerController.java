...
public class ZipBrokerController {
    ...
    public @ResponseBody List<byte[]> zipBrokerProcessor(@RequestParam(value = "jsonUrl") String jsonUrl, @RequestParam(value = "jsonScript") String jsonScript, @RequestParam(value = "jsonMapping") String jsonMapping, @RequestParam(value = "jsonPosition") String jsonPosition) {
        ...
        try {
            ...
            if(jsonRequestUrl.get("url")!=null) {
